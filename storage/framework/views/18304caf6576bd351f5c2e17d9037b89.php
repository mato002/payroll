                ...
                <div class="bg-white dark:bg-gray-950 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="<?php echo e(config('app.timezone')); ?>" disabled
                                   class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-2 text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-950 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e(app()->version()); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">PHP Version</span>
                            <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e(PHP_VERSION); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Environment</span>
                            <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e(config('app.env')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\payroll-system\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>