...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['structure' => null, 'currency' => 'USD']));
...
foreach (array_filter((['structure' => null, 'currency' => 'USD']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
        ...
        <div class="flex items-center gap-3">
            <div class="flex-1">
                ...
                <div class="relative">
                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400"><?php echo e($currency); ?></span>
                    <input
                        type="number"
                        id="base_salary"
                        name="base_salary"
                ...
                <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <div class="relative">
                                <span x-show="allowance.calculation_type === 'fixed'" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400"><?php echo e($currency); ?></span>
                    ...
                    <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span class="ml-2 font-semibold text-indigo-600 dark:text-indigo-400">
                            <?php echo e($currency); ?> <span x-text="formatCurrency(calculateAllowanceValue(allowance))"></span>
                        </span>
                    </div>
                </div>
            </template>
                ...
                <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <div class="relative">
                                <span x-show="deduction.calculation_type === 'fixed'" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400"><?php echo e($currency); ?></span>
                    ...
                    <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span class="ml-2 font-semibold text-red-600 dark:text-red-400">
                            <?php echo e($currency); ?> <span x-text="formatCurrency(calculateDeductionValue(deduction))"></span>
                        </span>
                    </div>
                </div>
            </template>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            <div>
                ...
                <p class="mt-1 text-2xl font-bold text-gray-900 dark:text-gray-100">
                    <?php echo e($currency); ?> <span x-text="formatCurrency(baseSalary)"></span>
                </p>
            </div>
            <div>
                ...
                <p class="mt-1 text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                    <?php echo e($currency); ?> <span x-text="formatCurrency(totalAllowances)"></span>
                </p>
            </div>
            <div>
                ...
                <p class="mt-1 text-2xl font-bold text-red-600 dark:text-red-400">
                    <?php echo e($currency); ?> <span x-text="formatCurrency(totalDeductions)"></span>
                </p>
            </div>
            <div class="border-l-2 border-indigo-300 pl-4 dark:border-indigo-600">
                ...
                <p class="mt-1 text-3xl font-bold text-indigo-600 dark:text-indigo-400">
                    <?php echo e($currency); ?> <span x-text="formatCurrency(netSalary)"></span>
                </p>
            </div>
        </div>
    </div>
...
function salaryStructureCalculator() {
    return {
        baseSalary: <?php echo e(($structure && $structure->components) ? ($structure->components->where('type', 'earning')->where('code', 'basic_salary')->first()?->amount ?? 0) : 0); ?>,
        allowances: <?php echo json_encode($structure && $structure->components ? $structure->components->where('type', 'earning')->where('code', '!=') ?>,
        deductions: <?php echo json_encode($structure && $structure->components ? $structure->components->where('type', 'deduction')->map(function($c) {
            return [
...
<?php /**PATH C:\xampp\htdocs\payroll-system\resources\views/components/salary-structure-form.blade.php ENDPATH**/ ?>