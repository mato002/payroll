...
<?php $__env->startSection('title', 'Features – ' . config('app.name', 'MatechPay')); ?>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
            <div class="max-w-2xl">
                ...
                <p class="mt-3 text-gray-600">
                    From onboarding to termination settlements, <?php echo e(config('app.name')); ?> streamlines the entire employee lifecycle.
                </p>
            </div>
            ...
            <div class="mt-16 grid gap-10 lg:grid-cols-2 lg:items-center">
                <div>
                    ...
                    <p class="mt-3 text-gray-600">
                        <?php echo e(config('app.name')); ?> walks you through each step, from importing timesheets to approving payouts, so
    ...
    <section class="bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            <div class="bg-indigo-600 rounded-2xl px-6 py-10 md:px-10 md:py-12 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                <div>
                    <h2 class="text-2xl font-semibold text-white">See <?php echo e(config('app.name')); ?> in action.</h2>
...
<?php echo $__env->make('layouts.marketing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\payroll-system\resources\views/features.blade.php ENDPATH**/ ?>