...
<?php $__env->startSection('title', __('Run payroll')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    <?php echo e(currentCompany()?->name); ?> · <?php echo e(__('Step :step of 4', ['step' => $step])); ?>
            ...
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="flex-1 flex items-center w-full sm:w-auto">
                    <div class="flex items-center gap-2 sm:gap-2 w-full sm:w-auto">
                        ...
                        <span
                            class="text-sm sm:text-xs <?php if($state === 'current'): ?> text-indigo-600 dark:text-indigo-300 font-semibold <?php elseif($state === 'complete'): ?> text-emerald-600 dark:text-emerald-300 <?php else: ?> text-gray-500 dark:text-gray-400 <?php endif; ?>"
                        >
                            <?php echo e($label); ?>

                        </span>
                    </div>
                    <?php if($index < count($steps)): ?>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 sm:p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
            ...
            ?>
            <form method="POST" action="<?php echo e(route($wizardStoreRoute, ['company' => currentCompany()?->slug])); ?>">
                <?php echo csrf_field(); ?>
                ...
                <?php if($step === 1): ?>
                    ...
                    <div class="space-y-4">
                        <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e(__('1. Select payroll period')); ?>

                        </h2>

                        <div class="grid gap-4 grid-cols-1 sm:grid-cols-3">
                            <label class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                <span class="mb-1 block"><?php echo e(__('Period start date')); ?></span>
                                <input
                                    type="date"
                                    name="period_start_date"
                                    value="<?php echo e(old('period_start_date', $wizard['period_start_date'] ?? '')); ?>"
                                    required
                            ...
                            <label class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                <span class="mb-1 block"><?php echo e(__('Period end date')); ?></span>
                                <input
                                    type="date"
                                    name="period_end_date"
                                    value="<?php echo e(old('period_end_date', $wizard['period_end_date'] ?? '')); ?>"
                                    required
                                    class="mt-1 block w-full rounded-md border-gray-300 text-base sm:text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 py-2.5 sm:py-1.5"
                                >
                            </label>
                            ...
                            <label class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                <span class="mb-1 block"><?php echo e(__('Pay date')); ?></span>
                                <input
                                    type="date"
                                    name="pay_date"
                                    value="<?php echo e(old('pay_date', $wizard['pay_date'] ?? '')); ?>"
                                    required
                                    class="mt-1 block w-full rounded-md border-gray-300 text-base sm:text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 py-2.5 sm:py-1.5"
                                >
                            </label>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <label class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                <span class="mb-1 block"><?php echo e(__('Run name (optional)')); ?></span>
                                <input
                                    type="text"
                                    name="name"
                                    value="<?php echo e(old('name', $wizard['name'] ?? '')); ?>"
                                    placeholder="<?php echo e(__('Monthly payroll :period', ['period' => now()->format('F Y')])); ?>"
                            ...
                            <label class="text-xs font-medium text-gray-700 dark:text-gray-300">
                                <span class="mb-1 block"><?php echo e(__('Description (optional)')); ?></span>
                                <textarea
                                    name="description"
                                    rows="2"
                                    class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
                                ><?php echo e(old('description', $wizard['description'] ?? '')); ?></textarea>
                            </label>
                        </div>
                    </div>
                <?php elseif($step === 2): ?>
                    ...
                    <div class="space-y-4">
                        <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e(__('2. Review employees in this run')); ?>

                        </h2>
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            <?php echo e(__('The following active employees will be included in this payroll run.')); ?>
                        ...
                        <div class="overflow-x-auto -mx-4 sm:mx-0 rounded-lg border border-gray-200 dark:border-gray-800">
                            <div class="inline-block min-w-full align-middle px-4 sm:px-0">
                                ...
                                <tr>
                                    <th class="px-3 py-2 text-left font-semibold text-gray-500 dark:text-gray-400"><?php echo e(__('Code')); ?></th>
                                    <th class="px-3 py-2 text-left font-semibold text-gray-500 dark:text-gray-400"><?php echo e(__('Name')); ?></th>
                                    <th class="px-3 py-2 text-left font-semibold text-gray-500 dark:text-gray-400"><?php echo e(__('Job title')); ?></th>
                                    <th class="px-3 py-2 text-left font-semibold text-gray-500 dark:text-gray-400"><?php echo e(__('Status')); ?></th>
                                </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-800 dark:bg-gray-950">
                                <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-3 py-1.5 whitespace-nowrap"><?php echo e($employee->employee_code); ?></td>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="4" class="px-3 py-3 text-center text-xs text-gray-500 dark:text-gray-400">
                                            <?php echo e(__('No active employees found for this company.')); ?>
                ...
                <?php elseif($step === 3): ?>
                    ...
                    <div class="space-y-4">
                        <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e(__('3. Review calculations (preview)')); ?>

                        </h2>
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            <?php echo e(__('A detailed breakdown will be available after processing. Below is a summary preview based on current employees and salary structures.')); ?>
                        ...
                        <div class="grid gap-4 grid-cols-1 sm:grid-cols-3">
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-3 text-xs dark:border-gray-800 dark:bg-gray-900">
                                <p class="font-medium text-gray-700 dark:text-gray-200">
                                    <?php echo e(__('Employees in run')); ?>

                                </p>
                                <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100">
                                    <?php echo e($employees->count()); ?>

                                </p>
                            </div>
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-3 text-xs dark:border-gray-800 dark:bg-gray-900">
                                <p class="font-medium text-gray-700 dark:text-gray-200">
                                    <?php echo e(__('Estimated total earnings')); ?>

                                </p>
                                <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-gray-100">
                                    <?php echo e(__('Will be calculated')); ?>

                                </p>
                            </div>
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-3 text-xs dark:border-gray-800 dark:bg-gray-900">
                                <p class="font-medium text-gray-700 dark:text-gray-200">
                                    <?php echo e(__('Estimated total net pay')); ?>
                ...
                <?php elseif($step === 4): ?>
                    ...
                    <div class="space-y-4">
                        <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            <?php echo e(__('4. Confirm and submit for approval')); ?>

                        </h2>
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            <?php echo e(__('Review the details below and confirm to create this payroll run. The system will calculate all employee payrolls and automatically submit it for approval.')); ?>
                        ...
                        <dl class="grid gap-4 grid-cols-1 sm:grid-cols-2 text-xs">
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-3 dark:border-gray-800 dark:bg-gray-900">
                                <dt class="font-medium text-gray-700 dark:text-gray-200"><?php echo e(__('Period')); ?></dt>
                                <dd class="mt-1 text-gray-900 dark:text-gray-100">
                                    <?php echo e($wizard['period_start_date'] ?? '—'); ?> → <?php echo e($wizard['period_end_date'] ?? '—'); ?>

                                </dd>
                            </div>
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-800 dark:bg-gray-900">
                                <dt class="font-medium text-gray-700 dark:text-gray-200"><?php echo e(__('Pay date')); ?></dt>
                                <dd class="mt-1 text-gray-900 dark:text-gray-100">
                                    <?php echo e($wizard['pay_date'] ?? '—'); ?>

                                </dd>
                            </div>
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-800 dark:bg-gray-900">
                                <dt class="font-medium text-gray-700 dark:text-gray-200"><?php echo e(__('Run name')); ?></dt>
                                <dd class="mt-1 text-gray-900 dark:text-gray-100">
                                    <?php echo e($wizard['name'] ?? __('Monthly payroll')); ?>

                                </dd>
                            </div>
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-800 dark:bg-gray-900">
                                <dt class="font-medium text-gray-700 dark:text-gray-200"><?php echo e(__('Employees in run')); ?></dt>
                                <dd class="mt-1 text-gray-900 dark:text-gray-100">
                                    <?php echo e($employees->count()); ?>
                        ...
                        <div class="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-800 dark:border-amber-900/60 dark:bg-amber-950 dark:text-amber-200">
                            <p class="font-medium mb-1"><?php echo e(__('Important:')); ?></p>
                            <p><?php echo e(__('By confirming, the system will calculate payroll for all active employees in the selected period and automatically submit the run for approval. Any configuration errors (missing salary data, etc.) will be reported. Once submitted, authorized approvers can review and approve the payroll run.')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="mt-6 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-0">
                    <div>
                        <?php if($step > 1): ?>
                            <a
                                href="<?php echo e(route($wizardCreateRoute, ['company' => currentCompany()?->slug, 'step' => $step - 1])); ?>"
                    ...
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        <?php else: ?>
                            ...
                            >
                                <?php echo e(__('Confirm & run payroll')); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\payroll-system\resources\views/payroll/runs/wizard.blade.php ENDPATH**/ ?>