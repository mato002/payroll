            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                <?php echo e($summary['total_companies']); ?>
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Active: <?php echo e($summary['active_companies']); ?>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                <?php echo e($summary['active_subscriptions']); ?>
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Trialing: <?php echo e($summary['trial_subscriptions']); ?>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                <?php echo e(number_format($summary['mrr'], 2)); ?>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                <?php echo e(number_format($summary['monthly_revenue'], 2)); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-2 align-top text-xs">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium <?php echo e($subColor); ?>">
                                        <?php echo e(strtoupper($subStatus)); ?>

                                    </span>
                                </td>
                                <td class="whitespace-nowrap px-4 py-2 align-top text-xs text-gray-700 dark:text-gray-200">
                                    <?php echo e(optional($company['next_billing'])->toDateString() ?? '—'); ?>
                                ...
                                <td class="whitespace-nowrap px-4 py-2 align-top text-xs">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium <?php echo e($companyColor); ?>">
                                        <?php echo e(strtoupper($companyStatus)); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\payroll-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>