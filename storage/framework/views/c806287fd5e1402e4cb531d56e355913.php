...
<?php $__env->startSection('title', 'Create New Company'); ?>
    ...
    <main class="flex-1">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-950 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
                <form method="POST" action="<?php echo e(route('admin.companies.store')); ?>" enctype="multipart/form-data" class="p-6 space-y-8" novalidate>
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="block w-full rounded-lg border <?php $__errorArgs = ['company_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 dark:bg-red-900/20 <?php else: ?> border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p id="company_name-error" class="mt-2 text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="block w-full rounded-lg border <?php $__errorArgs = ['billing_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 dark:bg-red-900/20 <?php else: ?> border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p id="billing_email-error" class="mt-2 text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-6" x-data="{ showPassword: false, showPasswordConfirmation: false }">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="block w-full rounded-lg border <?php $__errorArgs = ['admin_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 dark:bg-red-900/20 <?php else: ?> border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p id="admin_name-error" class="mt-2 text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="block w-full rounded-lg border <?php $__errorArgs = ['admin_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 dark:bg-red-900/20 <?php else: ?> border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p id="admin_email-error" class="mt-2 text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        class="block w-full rounded-lg border <?php $__errorArgs = ['admin_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 dark:bg-red-900/20 <?php else: ?> border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> px-4 py-2.5 pr-10 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p id="admin_password-error" class="mt-2 text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="country" name="country" value="<?php echo e(old('country')); ?>" placeholder="KE" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                </div>
                                <div>
                                    <label for="timezone" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Timezone</label>
                                    <input type="text" id="timezone" name="timezone" value="<?php echo e(old('timezone', config('app.timezone'))); ?>" placeholder="UTC" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="currency" name="currency" value="<?php echo e(old('currency', 'USD')); ?>" required placeholder="USD" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                </div>
                            </div>

                            <div>
                                <label for="address_line1" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Address line 1</label>
                                <input type="text" id="address_line1" name="address_line1" value="<?php echo e(old('address_line1')); ?>" placeholder="123 Main Street" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                            </div>

                            <div>
                                <label for="address_line2" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Address line 2</label>
                                <input type="text" id="address_line2" name="address_line2" value="<?php echo e(old('address_line2')); ?>" placeholder="Suite 100" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                            </div>

                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    <label for="city" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">City</label>
                                    <input type="text" id="city" name="city" value="<?php echo e(old('city')); ?>" placeholder="Nairobi" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                </div>
                                <div>
                                    <label for="state" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">State</label>
                                    <input type="text" id="state" name="state" value="<?php echo e(old('state')); ?>" placeholder="State" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                </div>
                                <div>
                                    <label for="postal_code" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Postal code</label>
                                    <input type="text" id="postal_code" name="postal_code" value="<?php echo e(old('postal_code')); ?>" placeholder="00100" class="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-3">
                                <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <label class="block p-4 rounded-lg border-2 <?php echo e($isSelected ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-700 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/10'); ?> cursor-pointer transition-all duration-200">
                                        <div class="flex items-start">
                                            <input
                                                type="radio"
                                                name="plan_code"
                                            ...
                                            <div class="ml-3 flex-1">
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <span class="font-bold text-gray-900 dark:text-gray-100"><?php echo e($plan->name); ?></span>
                                                        <span class="ml-2 text-xs text-gray-500 dark:text-gray-400">(<?php echo e($plan->billing_model); ?>)</span>
                                                    </div>
                    ...
                    <div class="pt-8 border-t border-gray-200 dark:border-gray-800 flex items-center justify-between">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                            Cancel
                        </a>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\payroll-system\resources\views/admin/companies/create.blade.php ENDPATH**/ ?>