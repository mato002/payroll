...
<head>
    ...
    <title>Log in – {{ config('app.name', 'MatechPay') }}</title>
...
<body class="antialiased bg-gradient-to-br from-gray-50 via-indigo-50/30 to-white min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 p-8 sm:p-10">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6" x-data="{ showPassword: false }" novalidate>
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="block w-full pl-10 pr-3 py-3 rounded-xl border @error('email') border-red-300 bg-red-50 @else border-gray-300 bg-white @enderror shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm transition-colors"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="block w-full pl-10 pr-10 py-3 rounded-xl border @error('password') border-red-300 bg-red-50 @else border-gray-300 bg-white @enderror shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm transition-colors"
            ...
            @if (Route::has('company.signup'))
                <div class="mt-8 pt-6 border-t border-gray-200">
                    <p class="text-sm text-gray-600 text-center">
                        New company? <a href="{{ route('company.signup') }}" class="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">Start your free trial</a>.
                    </p>
                </div>
            @endif
        </div>
