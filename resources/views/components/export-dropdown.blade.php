...
<div x-data="exportManager('{{ $exportUrl }}', {{ json_encode($formats) }}, '{{ $defaultFormat }}')" class="relative">
        ...
        >
            <div class="py-1">
                ...
                @foreach($formats as $format => $label)
                    ...
                    >
                        <span>{{ $label }}</span>
                        <svg x-show="selectedFormat === '{{ $format }}'" class="h-4 w-4 text-indigo-600 dark:text-indigo-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
