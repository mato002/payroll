...
@php
    $inputId = $id ?? ($name ? $name . '_' . ($value ?? uniqid()) : uniqid('radio_'));
    $baseClasses = 'h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700';
