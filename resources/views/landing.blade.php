...
@section('title', config('app.name') . ' – Payroll Management System')
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-12 xl:gap-16 items-center max-w-7xl mx-auto">
                <div class="lg:col-span-7">
                    ...
                    <div class="mt-10 flex items-center space-x-4 text-sm text-gray-600">
                        ...
                        <p class="text-gray-700"><span class="font-semibold">500+ companies</span> run payroll with {{ config('app.name') }}.</p>
                    </div>
                </div>
