...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold mb-6">Tax Summary Report</h1>

        <form action="{{ route('companies.reports.tax.generate', ['company' => currentCompany()?->slug]) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            @csrf
